...
<body>
    ...
    <head>
        ...
        <title>CodePen - Yeti Login from Darin S</title>
    ...
    <body>
        ...
        <form method="post">
            ...
            if (isset($_GET['pesan'])) {
                if ($_GET['pesan'] == 'gagal') {
                    echo "<div class='alert alert-danger'><b>Username atau Password Salah</b></div>";
                } elseif ($_GET['pesan'] == 'logout') {
                    echo "<div class='alert alert-success'><b>Logout Berhasil</b></div>";
                } elseif ($_GET['pesan'] == 'ilegal') {
                    echo "<div class='alert alert-primary'><b>Antum Masuk Ilegal Brodi</b></div>";
                }
            }
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" id="email" class="email" maxlength="256" name="user" />
            ...
            <div class="inputGroup inputGroup2">
                ...
                <input type="password" id="password" class="password" name="pass" />
